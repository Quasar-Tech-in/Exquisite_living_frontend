...
export const cardsData: CardData[] = [
  ...
  {
    title: "Attentiveness",
    subtext: "The details that make all the difference.",
    desc: "Luxury is often found in the smallest details. We notice the preferences, habits, and routines that quietly shape your life, ensuring every interaction feels considered, familiar, and effortlessly personal.",
  },
  {
    title: "Intuition",
    subtext: "Where familiarity becomes instinct.",
    desc: "Over time, understanding becomes second nature. The deeper our relationship, the more naturally we anticipate your preferences, creating experiences that feel seamless, thoughtful, and quietly curated.",
  },
